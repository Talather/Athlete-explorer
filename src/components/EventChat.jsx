...
const EventChat = ({ event }) => {
  ...
  if (!event) {
    return (
      <div className="h-[60vh] flex items-center justify-center text-gray-500 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
  ...
  return (
    <div className="mt-10 h-[60vh] flex flex-col bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden">
      {/* Chat header */}
