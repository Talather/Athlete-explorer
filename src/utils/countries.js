...
export const getCountryFlag = (countryCode) => {
  ...
  // For special case of Kosovo (XK) which doesn't have an official emoji flag
  if (countryCode === 'XK') return '🇽🇰';
  
  // Convert country code to regional indicator symbols
  // Each regional indicator symbol is an emoji letter (e.g., 🇦 for A, 🇧 for B, etc.)
...
/**
 * Get the flag emoji from country name
 * @param {string} countryName - Country name to get flag for
 * @returns {string} Flag emoji or empty string if not found
 */
export const getCountryFlagFromName = (countryName) => {
